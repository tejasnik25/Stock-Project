...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Strategies Section */}
      <section id="strategies" className="py-20 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-xl mx-auto">
            <div className="rounded-2xl border border-dashed border-gray-300 dark:border-gray-700 bg-gray-50/60 dark:bg-gray-900/60 px-6 py-10 text-center">
              <p className="text-gray-700 dark:text-gray-200 text-base md:text-lg font-medium mb-4">
                No strategies yet
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                Strategies you create or that become available will appear here.
              </p>
              <div className="flex items-center justify-center gap-3">
                <Link
                  href="/login"
                  className="inline-flex items-center justify-center rounded-md bg-gradient-to-r from-blue-600 to-purple-600 px-5 py-2.5 text-sm font-medium text-white shadow-md hover:from-blue-700 hover:to-purple-700 hover:shadow-lg transition duration-300"
                >
                  Login to View
                </Link>
                <Link
                  href="/strategies"
                  className="inline-flex items-center justify-center rounded-md border border-gray-300 dark:border-gray-700 px-5 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition duration-300"
                >
                  View Strategies Page
                </Link>
              </div>
            </div>
          </div>
